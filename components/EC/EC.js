...
export default function EC() {
	return (
		<div className='w-full flex flex-col justify-center items-center'>
			...
			<div className='w-screen overflow-hidden justify-center pt-16 pb-80 mt-16 bg-[#602042] dark:bg-gray-800'>
						...
						<div className='justify-center text-center flex-col pt-6'>
							...
							<div className='grid md:grid-cols-2 gap-10 mt-20 justify-center'>
								...
								<div className='flex flex-col md:pb-0 pb-20 items-center'>
									<h2 className='font-subHeading font-semibold text-center text-white md:text-3xl text-2xl md:mb-40 mb-20'>
										Operations Wing
									</h2>
									<Wing cards={opswing} />
								</div>
								<div className='flex flex-col pb-20 items-center '>
									<h2 className='font-subHeading font-semibold text-center justify-center text-white md:text-3xl text-2xl md:mt-0 mt-60 md:mb-40 mb-20'>
										Presidential Wing
									</h2>
							...
							<div className='grid md:grid-cols-2 gap-10 mt-20 justify-center'>
								...
								{/* Display two wings per row on desktop */}
								<div className='flex flex-col pb-20 items-center'>
									<h2 className='font-subHeading font-semibold text-center justify-center text-white md:text-3xl text-2xl md:mt-80 mt-60 md:mb-40 mb-20'>
										Coordination Wing
									</h2>
									<Wing cards={coorwing} />
								</div>
								<div className='flex flex-col md:pb-0 pb-20 items-center'>
									<h2 className='font-subHeading font-semibold text-center justify-center text-white md:text-3xl text-2xl md:mt-80 mt-60 md md:mb-40 mb-20'>
										Media Wing
									</h2>
