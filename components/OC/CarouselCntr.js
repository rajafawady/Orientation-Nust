  ...
  return (
    <div className="">
      <div className="flex justify-between p-10 pt-12">
        <div>
          <img
            src="/svg/blue-svg/1.svg"
            className="w-36 md:w-48 hidden dark:block  lg:w-60"
          />
          <img
            src="/svg/purple-svg/1.svg"
            className="w-36 md:w-48 dark:hidden lg:w-60"
          />
        </div>
        ...
        <div>
          <img
            src="/svg/blue-svg/2.svg"
            className="w-36 md:w-48  hidden dark:block  lg:w-60"
          />
          <img
            src="/svg/purple-svg/2.svg"
            className="w-36 md:w-48 dark:hidden lg:w-60"
          />
        </div>
      </div>
