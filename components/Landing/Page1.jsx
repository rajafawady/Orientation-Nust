...
const Page1 = () => {
  return (
    <div className="text-white h-screen relative z-10">
      <div className="flex flex-col px-20 h-full py-20 justify-evenly font-mont">
        ...
        <div className="max-w-3xl text-lg text-justify ">
          ...
          unde ducimus explicabo laudantium reiciendis ipsam tempore pariatur
          odit dolorum at totam exercitationem illo quidem minima vero numquam
          a, omnis corrupti.
        </div>
        <TimerContainer />
      </div>
