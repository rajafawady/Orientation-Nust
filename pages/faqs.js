		...
		<Layout title={'FAQs'}>
			<div className='mt-24 px-8'>
				<h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-center'>
					A <span className='text-tyrian-purple'>Few Things</span> Students
					<br />
					Ask About <span className='text-tyrian-purple '>Orientation</span>
				</h1>
				<p className='text-xl font-normal text-center mt-4 opacity-70'>
					If you need any other help or have a question, please reach out to us.
				</p>
			</div>

			<div className='mt-24 grid mx:0 lg:mx-48 faq-grid px-8'>
				<Categories
					categories={faqs.map((faq) => faq.name)}
